            ...
            context.isDarkTheme
                ...
                : Center(
                    child: Container(
                      ...
                      child: Image.asset(AppImages.logo, width: 80, height: 80),
                    ),
                  ),
      ...
      builder: (context, state) {
        return Container(
          ...
          child: CustomTextField(
            ...
            contentStyle: context.bodyText.copyWith(
              fontSize: 14,
              color: AppColorTheme().black,
            ),
            prefixIcon: Icon(AppIcons().email, color: AppColorTheme().primary),
            ...
            error:
                (state.forgotPasswordException.errors?.email != null &&
